...
var stfServicePkg = require('@devicefarmer/stfservice-prebuilt/package.json')
...
module.exports = syrup.serial()
  ...
  .define(function(options, adb, sdk) {
    ...
    var builder = ProtoBuf.loadProtoFile(pathutil.module(
      '@devicefarmer/stfservice-prebuilt/prebuilt/noarch/wire.proto'))

    var resource = {
      requiredVersion: stfServicePkg.version
    , pkg: 'jp.co.cyberagent.stf'
    , main: 'jp.co.cyberagent.stf.Agent'
    , apk: pathutil.module(
        '@devicefarmer/stfservice-prebuilt/prebuilt/noarch/STFService.apk')
